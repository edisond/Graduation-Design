(function (a, b) {
        ...
        return {
            ...
            isOverflow: function (h) {
                ...
                var i = a(h).attr("min"),
                    ...
                    g, e, c, f = h.value;
                if (!i && !d) {
                    e = a(h).attr("data-min"), c = a(h).attr("data-max");
                    if (e && f.length < e) {
                    ...
                    h = function (k, n, s) {
                        ...
                        if (a(k).isVisible()) {
                            if (n == "radio" || n == "checkbox") {
                                ...
                                if (s == "select" || s == "empty") {
                                    a(k).testRemind((s == "empty" && r) ? "请填写此字段" : OBJREG.prompt[s]);
                                    k.focus()
                                } else {
    ...
    a.fn.extend({
        ...
        testRemind: function (j, n) {
            ...
            n = n || {};
            n.css = a.extend({}, f.css, n.css || a.testRemind.css);
            var e = a.extend({}, f, n || {});
        ...
        html5Validate: function (g, c) {
            ...
            a(this).bind("submit", function () {
                if (a.html5Validate.isAllpass(d, f) && f.validate() && a.isFunction(g)) {
                    g.call(this)
                }
                return false
            });
