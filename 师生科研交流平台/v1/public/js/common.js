...
$.fn.extend({
    Wysiwyg: function (options) {
        return $(this).each(function () {
            ...
            toolbar += '<div class="btn-group"><a class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" title="超链接"><i class="fa fa-link"></i></a><div class="dropdown-menu input-append p10"><input class="form-control" placeholder="URL" type="text" data-edit="createLink" /><button class="btn btn-default btn-sm mt5" type="button">添加</button></div></div>';
